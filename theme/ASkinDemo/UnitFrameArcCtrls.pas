...
type
  TFrame_ArcCtrls = class(TCustomInfoFrame)
    ...
    procedure sArcHandle1GetHandlePaintData(Sender: TObject; var PaintData: TacButtonPaintData);
    procedure sArcDial1GetHandlePaintData(Sender: TObject; var PaintData: TacButtonPaintData);
