...
begin
  ...
  sVirtualImageList1.AlphaImageList := TsAlphaImageList(SkinManager_Preview.SkinListController.ImgList);
...
begin
  if IsValidIndex(Index, sListBox1.Items.Count) then begin
    ...
    if sListBox1.SkinData.Skinned then begin
      ...
      if odSelected in State {sListBox1.ItemIndex = Index} then begin
